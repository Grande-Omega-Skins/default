...
const ConsoleHelper = require("../../src/chrome/consoleHelper");
suite('ConsoleHelper', () => {
    setup(() => {
     ...
     */
    function doAssertForString(params, expectedText, expectedIsError = false) {
...
(function (Runtime) {
     ...
     */
    function makeMockMessage(type, args, overrideProps) {
        const message = {
            type,
    ...
    Runtime.makeLog = makeLog;
    function makeAssert(...args) {
