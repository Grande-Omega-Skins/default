...
suite('SourceMaps', () => {
    ...
    const DIRNAME = utils_1.fixDriveLetterAndSlashes(__dirname);
    ...
    const sourceMaps = new sourceMaps_1.SourceMaps(PATH_MAPPING);
    setup((done) => {
    ...
    test('mapToGenerated is case insensitive', () => {
        const position = { line: 0, column: 0, source: GENERATED_PATH };
    ...
    test('mapToAuthored is case insensitive', () => {
        const position = { line: 0, column: 0, name: null, source: AUTHORED_PATH };
