...
const serviceRegistry_8 = require("./debugger/serviceRegistry");
const types_5 = require("./debugger/types");
...
const serviceRegistry_12 = require("./terminals/serviceRegistry");
const types_9 = require("./terminals/types");
...
const serviceRegistry_13 = require("./unittests/serviceRegistry");
...
function activate(context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const standardOutputChannel = serviceManager.get(types_4.IOutputChannel, constants_1.STANDARD_OUTPUT_CHANNEL);
        ...
        serviceManager.get(types_9.ICodeExecutionManager).registerCommands();
        ...
        const lintingEngine = serviceManager.get(types_8.ILintingEngine);
        ...
        const persistentStateFactory = serviceManager.get(types_4.IPersistentStateFactory);
        ...
        context.subscriptions.push(serviceContainer.get(types_6.IInterpreterSelector));
        ...
        serviceContainer.getAll(types_5.IDebugConfigurationProvider).forEach(debugConfig => {
...
function registerServices(context, serviceManager, serviceContainer) {
    serviceManager.addSingletonInstance(types_7.IServiceContainer, serviceContainer);
    serviceManager.addSingletonInstance(types_7.IServiceManager, serviceManager);
    ...
    serviceManager.addSingletonInstance(types_4.IOutputChannel, unitTestOutChannel, constants_3.TEST_OUTPUT_CHANNEL);
...
function sendStartupTelemetry(activatedPromise, serviceContainer) {
    return __awaiter(this, void 0, void 0, function* () {
        const logger = serviceContainer.get(types_4.ILogger);
        try {
            yield activatedPromise;
            const terminalHelper = serviceContainer.get(types_3.ITerminalHelper);
