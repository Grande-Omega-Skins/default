...
suite('Debugging - Banner', () => {
    ...
    test('Increment Debugger Launch Counter when debug session starts', () => __awaiter(this, void 0, void 0, function* () {
        ...
        showBannerState.setup(s => s.value).returns(() => true)
            .verifiable(typemoq.Times.once());
        banner.initialize();
        onDidStartDebugSessionCb({ type: constants_1.ExperimentalDebuggerType });
        launchCounterState.verifyAll();
        browser.verifyAll();
        debugService.verifyAll();
        showBannerState.verifyAll();
    }));
    test('Do not Increment Debugger Launch Counter when debug session starts when Banner is disabled', () => __awaiter(this, void 0, void 0, function* () {
        debugService.setup(d => d.onDidStartDebugSession(typemoq.It.isAny()))
    ...
    test('shouldShowBanner returnes false when Banner is disabled', () => __awaiter(this, void 0, void 0, function* () {
        showBannerState.setup(s => s.value).returns(() => false)
            .verifiable(typemoq.Times.once());
        chai_1.expect(yield banner.shouldShowBanner()).to.be.equal(false, 'Incorrect value');
        showBannerState.verifyAll();
    }));
    test('shouldShowBanner returnes false when Banner is enabled and debug counter is not same as threshold', () => __awaiter(this, void 0, void 0, function* () {
        showBannerState.setup(s => s.value).returns(() => true)
            .verifiable(typemoq.Times.once());
    ...
    test('shouldShowBanner returnes true when Banner is enabled and debug counter is same as threshold', () => __awaiter(this, void 0, void 0, function* () {
        showBannerState.setup(s => s.value).returns(() => true)
            .verifiable(typemoq.Times.once());
    ...
    test('Disabling banner should store value of \'false\' in global store', () => __awaiter(this, void 0, void 0, function* () {
