...
suite('Formatting', () => {
    ...
    suiteSetup(() => __awaiter(this, void 0, void 0, function* () {
        ...
        const pythonProcess = yield ioc.serviceContainer.get(types_1.IPythonExecutionFactory).create({ resource: vscode.Uri.file(workspaceRootPath) });
        const py2 = (yield ioc.getPythonMajorVersion(vscode.Uri.parse(originalUnformattedFile))) === 2;
    ...
    function testFormatting(formatter, formattedContents, fileToFormat, outputFileName) {
        return __awaiter(this, void 0, void 0, function* () {
            const textDocument = yield vscode.workspace.openTextDocument(fileToFormat);
            ...
            const edits = yield formatter.formatDocument(textDocument, options, new vscode.CancellationTokenSource().token);
    ...
    test('AutoPep8', () => __awaiter(this, void 0, void 0, function* () { return testFormatting(new autoPep8Formatter_1.AutoPep8Formatter(ioc.serviceContainer), formattedAutoPep8, autoPep8FileToFormat, 'autopep8.output'); }));
    test('Black', function () {
        return __awaiter(this, void 0, void 0, function* () {
            if ((yield ioc.getPythonMajorVersion(vscode.Uri.parse(blackFileToFormat))) === 2) {
