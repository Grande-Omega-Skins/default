...
suite('Module Installer', () => {
    [undefined, vscode_1.Uri.file(__filename)].forEach(resource => {
        ...
        function initializeDI() {
            ...
            ioc.serviceManager.addSingleton(types_5.IPersistentStateFactory, persistentState_1.PersistentStateFactory);
            ioc.serviceManager.addSingleton(types_5.ILogger, logger_1.Logger);
            ioc.serviceManager.addSingleton(types_5.IInstaller, productInstaller_1.ProductInstaller);
            ...
            mockTerminalFactory.setup(t => t.getTerminalService(TypeMoq.It.isAny()))
                ...
                .returns(() => mockTerminalService.object);
            ioc.serviceManager.addSingletonInstance(types_4.ITerminalServiceFactory, mockTerminalFactory.object);
            ioc.serviceManager.addSingleton(types_1.IModuleInstaller, pipInstaller_1.PipInstaller);
            ioc.serviceManager.addSingleton(types_1.IModuleInstaller, condaInstaller_1.CondaInstaller);
            ioc.serviceManager.addSingleton(types_1.IModuleInstaller, pipEnvInstaller_1.PipEnvInstaller);
            ...
            ioc.serviceManager.addSingleton(types_5.IPathUtils, pathUtils_1.PathUtils);
            ioc.serviceManager.addSingleton(types_5.ICurrentProcess, currentProcess_1.CurrentProcess);
            ioc.serviceManager.addSingleton(types_2.IFileSystem, fileSystem_1.FileSystem);
            ioc.serviceManager.addSingleton(types_2.IPlatformService, platformService_1.PlatformService);
            ioc.serviceManager.addSingleton(types_5.IConfigurationService, service_1.ConfigurationService);
            ioc.registerMockProcessTypes();
            ioc.serviceManager.addSingletonInstance(types_5.IsWindows, false);
        }
        function resetSettings() {
            return __awaiter(this, void 0, void 0, function* () {
                const configService = ioc.serviceManager.get(types_5.IConfigurationService);
        ...
        function getCurrentPythonPath() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (path.basename(pythonPath) === pythonPath) {
                    const pythonProc = yield ioc.serviceContainer.get(types_3.IPythonExecutionFactory).create({ resource: workspaceUri });
        ...
        test('Ensure pip is supported and conda is not', () => __awaiter(this, void 0, void 0, function* () {
            ioc.serviceManager.addSingletonInstance(types_1.IModuleInstaller, new moduleInstaller_1.MockModuleInstaller('mock', true));
            ...
            const moduleInstallers = ioc.serviceContainer.getAll(types_1.IModuleInstaller);
        ...
        test('Ensure pip is supported', () => __awaiter(this, void 0, void 0, function* () {
            ...
            const mockInterpreterLocator = TypeMoq.Mock.ofType();
            mockInterpreterLocator.setup(p => p.getInterpreters(TypeMoq.It.isAny())).returns(() => Promise.resolve([Object.assign({}, info, { architecture: types_2.Architecture.Unknown, companyDisplayName: '', displayName: '', envName: '', path: pythonPath, type: contracts_1.InterpreterType.Conda, version: '' })]));
            ioc.serviceManager.addSingletonInstance(contracts_1.IInterpreterLocatorService, mockInterpreterLocator.object, contracts_1.INTERPRETER_LOCATOR_SERVICE);
            ioc.serviceManager.addSingletonInstance(contracts_1.IInterpreterLocatorService, TypeMoq.Mock.ofType().object, contracts_1.PIPENV_SERVICE);
            const processService = yield ioc.serviceContainer.get(types_3.IProcessServiceFactory).create();
            processService.onExec((file, args, options, callback) => {
        ...
        test('Ensure conda is supported', () => __awaiter(this, void 0, void 0, function* () {
            ...
            serviceContainer.setup(c => c.get(TypeMoq.It.isValue(types_5.IConfigurationService))).returns(() => configService.object);
