...
const grep = constants_1.IS_CI_SERVER && constants_1.IS_CI_SERVER_TEST_DEBUGGER ? 'Debug' : undefined;
...
if (constants_1.MOCHA_REPORTER_JUNIT) {
    options.reporter = 'mocha-junit-reporter';
    options.reporterOptions = {
        mochaFile: constants_1.MOCHA_CI_REPORTFILE,
        properties: constants_1.MOCHA_CI_PROPERTIES
    };
}
