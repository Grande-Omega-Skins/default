...
class TestRunner {
    start() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const newAnalysisEngineLogFiles = [];
            for (let i = 0; i < timesToLoadEachVersion; i += 1) {
                yield this.enableNewAnalysisEngine(false);
                ...
                // New Analysis engine.
                yield this.enableNewAnalysisEngine(true);
                ...
                yield this.capturePerfTimes(Version.Release, newAnalysisEngineLogFile);
                newAnalysisEngineLogFiles.push(newAnalysisEngineLogFile);
            }
            console.log('Compare Performance Results');
            yield this.runPerfTest(devLogFiles, releaseLogFiles, newAnalysisEngineLogFiles);
        });
    }
    enableNewAnalysisEngine(enable) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    runPerfTest(devLogFiles, releaseLogFiles, newAnalysisEngineLogFiles) {
        return __awaiter(this, void 0, void 0, function* () {
            const env = {
